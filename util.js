var Utils={
    ...
    // cloneObject:function(animableObject){
    //     let self=this;
    //     let initPosition=this.objectInitializationPosition();
    //     if(animableObject.type==="ImageAnimable"){
    //         let animObj=new ImageAnimable({
    //             "left":animableObject.left+10,
    //             "top":animableObject.top+10,
    //             "imageAssetModel":animableObject.imageAssetModel,
    //
    //             "largeImage":animableObject.largeImage.cloneNode(),
    //             "thumbnailImage":animableObject.thumbnailImage.cloneNode(),
    //         })
    //         animObj.setCoords();
    //
    //         self.setupNewObject(animObj);
    //
    ...
    //
    //             self.setupNewObject.bind(self)(shapeAnimable);
    //         })
    //     }
